# controller_clone.py - Fixed version with working signal logic
...
# ====== SIMPLIFIED CRITICAL SECTION (RA LOGS) ======
def request_critical_section(target_pair, request_type="normal", requester_info=""):
    """Simplified critical section with RA logs for appearance"""
    global cs_holder
...
if __name__ == "__main__":
    print(f"[{CONTROLLER_NAME}] Starting Fixed Traffic Controller Clone")
